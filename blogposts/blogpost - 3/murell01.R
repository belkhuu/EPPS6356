...
lines(x, y1)
lines(x, y2)
points(x, y1, pch=16, cex=2) # Try different cex value? Size of the circle dots
points(x, y2, pch=21, bg="pink", cex=2)  # Different background color of the circles
par(col="gray50", fg="gray50", col.axis="gray50")
axis(1, at=seq(0, 16, 4)) # What is the first number standing for? Position, bottom
axis(2, at=seq(0, 6, 2)) # Position left
axis(4, at=seq(0, 6, 2)) # Position right
box(bty="u") #Close the box
